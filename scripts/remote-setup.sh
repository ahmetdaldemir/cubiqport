...
apt-get update -qq
apt-get install -y -qq curl git build-essential postgresql-client
...
# ── 4. PostgreSQL — create database ─────────────────────────────────────────
echo "[4/8] Creating cubiqport database (if not exists)…"
...
# ── 5. npm install ────────────────────────────────────────────────────────────
echo "[5/8] Installing npm workspace dependencies…"
cd "$APP_DIR"
...
# ── 8. nginx config ───────────────────────────────────────────────────────────
echo "[8/8] Configuring nginx on port 8083…"
